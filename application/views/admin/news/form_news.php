              ...
              <div class="box-body">
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="name" placeholder="Enter Judul" name="judul">
                    <span class="text-danger"><?php echo form_error('judul'); ?></span>
                  </div>

                <div class="form-group">
                  <label for="image">Gambar</label>
                  <input type="file" class="" id="image" name="gambar">
                ...
                <div class="form-group">
                  ...
                  <select class="form-control" name="kategori">
                    ...
                    <option value="<?php echo $kg->id_category; ?>"><?php echo $kg->category; ?></option>
                ...
                <div class="form-group">
                    ...
                    <textarea type="text" id="teks" name="teks" class="form-control"></textarea>
                ...
                <div class="box-body">
                  <div class="form-group">
                    ...
                    <input type="text" class="form-control" id="pen" placeholder="Enter Penulis" name="penulis">
